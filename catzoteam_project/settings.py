...
# Use Cloudinary for media files only (Django 4.2 compatible)
...
try:
    ...
    print(f"✓ Tesseract configured in settings: {TESSERACT_CMD} (OS: {platform.system()})")
except ImportError:
    print("⚠ pytesseract not installed - OCR features will not work")
